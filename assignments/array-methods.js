...
function totalDonations() {
  ...
  let arrayOfDoantions = [];
  arrayOfDoantions = runners.map(runner => runner.donation);
  ticketPriceTotal = arrayOfDoantions.reduce((total, i) => {
    return total + i;
  }, 0);
  //console.log(arrayOfDoantions);
...
function countCompanies() {
  ...
  let totalCompanies = companies.filter(unique);
  console.log(`Total Unique Companies: ${totalCompanies.length}`);
}

countCompanies();
// Problem 2
function bigDonations() {
  donationsOver100 = [];
  donationsOver100 = runners.filter(runner => runner.donation > 100);
  return donationsOver100;
}

console.log(bigDonations());
// Problem 3
function bigDonationsAdded() {
  donationsOver100 = [];
  donationsOver100 = runners.filter(runner => runner.donation > 100);
  // console.log(donationsOver100);
  let donations = [];
  donationsOver100.forEach(runner => donations.push(runner.donation));
  console.log(donations);
  let total = 0;
  total = donations.reduce((total, i) => {
    return total + i;
  }, 0);
  console.log(`Amount donated by big donaters: ${total}`);
}
